...
import { addWorkshopParticipant, assignUniqueCode, getAllWorkshopParticipants, sendToAllWorkshopParticipants, validateWorkshopParticipant } from '../controller/workshop.registeration.controller';
